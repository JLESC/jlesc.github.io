...
Although not directly related to this JLESC project, IPPL and it's ascent based in-situ interface are used in {% cite marrinan2025intuitive --file external/insitu_ippl_libyt.bib %} and {% cite marrinan2025real --file external/insitu_ippl_libyt.bib %}.  
