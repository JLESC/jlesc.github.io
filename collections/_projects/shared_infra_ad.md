...
We have published the paper on {HFBTHO-AD}{% cite HascoetEtAl2024 --file jlesc.bib %}. We are differentiating the reference BLAS code using Tapenade. We have used AI tools to generate the invocations of Tapenade and the testing code.
