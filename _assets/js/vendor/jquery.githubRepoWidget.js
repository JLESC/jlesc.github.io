;jQuery(document).ready(function($){
    ...
    $('.github-widget').each(function(){
        ...
        $widget = $(
                ...
                +'<a class="stargazers" href="' + repoUrl + '/stargazers" title="See stargazers" data-toggle="tooltip"><i class="fa fa-fw fa-star"></i><span class="text">?</span></a>'
                +'<a class="watchers" href="' + repoUrl + '/watchers" title="See watchers" data-toggle="tooltip"><i class="fa fa-fw fa-eye"></i><span class="text">?</span></a>'
                +'<a class="forks" href="' + repoUrl + '/network/members" title="See forkers" data-toggle="tooltip"><i class="fa fa-fw fa-code-fork"></i><span class="text">?</span></a>'
                +'</span>'
                +'</div>'
                ...
                +'<a class="pull-right hidden-xs hidden-sm" href="' + repoUrl + '/zipball/master" title="Get a zip archive of this repository" data-toggle="tooltip"><i class="fa fa-download fa-fw"></i></a>'
                +'</div></div>'
                +'</div>'
        );
