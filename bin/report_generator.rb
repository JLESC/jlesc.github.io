...
[+Jekyll::Site#write+]
  ...
  Writes each rendered and _Pandoc_-processed +Jekyll::Document+'s content of the _projects_
...
[+Jekyll::Renderer#run+]
  ...
  processing.
  After the Liquid engine is done, the output is passed to _Pandoc_ for the final conversion from
  Markdown to LaTeX.
...
module Jekyll
  ...
  class Renderer
    ...
    def md_cleanup
      ...
      # the table listing the person-months efforts needs a heading _Pandoc_ understands
    ...
    private
    ##
    # Cleans up the LaTeX as generated by _Pandoc_
    #
    def tex_cleanup
