...
defines the interface for the C++ numerical kernels. The ChASE algorhtm 
...
desxription will appear in a manuscript submission in early March 2018.
...
seamlessly to the Jena BSE requirements. One of the the major obstacles in this sense 
comes from the absence of a parallel I/O for the Jena code. This is
an essential task that will have to be tackled before full integration
can be achieved. We propose to achieve such result by modifying the 
Jena BSE code in such a way as to accommodate the HDF5 standard.
