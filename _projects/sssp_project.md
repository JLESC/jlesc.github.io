...
We have performed 6 tnraditional benchmarks and 7 mini applications on 6 systems to calculate the SSP and SSSP metrics.
...
Miwako Tsuji, William T. C. Kramer and Mitsuhisa Sato,"A Performance Projection of Mini-Applications onto Benchmarks Toward the Performance Projection of Real-Applications", 2017 IEEE International Conference on Cluster Computing (CLUSTER) Workshop on Representative Applications (WRAp)
