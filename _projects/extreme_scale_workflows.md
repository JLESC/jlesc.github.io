...
Cluster 2017 {% cite dreher_cluster17 --file jlesc.bib %} and was presented by Matthieu Dreher.
...
Cluster 2017 {% cite mommessin_cluster17 --file jlesc.bib %} and was presented by Matthieu Dreher on behalf of Clement
Mommessin.
...
{% cite dorier_pdsw17 --file jlesc.bib %} that introduces the idea of contract-based storage systems and presents some of
...
presented a concept paper at the SC17 ISAV workshop {% cite dreher_isav17 --file jlesc.bib %} on these topics.
