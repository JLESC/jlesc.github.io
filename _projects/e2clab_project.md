...
On the reproducibility front, Daniel Rosenedo presented a paper on practical reproducibility in Edge-to-Cloud experiments (KheOps: Cost-effective Repeatability, Reproducibility, and Replicability of Edge-to-Cloud Experiments, https://dl.acm.org/doi/abs/10.1145/3589806.3600032) at the ACM REP conference on June 27, 2023. The results presented in the paper were largely an outcome of the joint work performed in the prior year.

On the ANL side, we continued our investment in reproducibility topics by engaging a wide community of researchers and educators to advance the mission of popularizing the concept of practical reproducibility in Computer Science. This work was performed as part of the ANL-led REPETO project (https://repeto.cs.uchicago.edu/). We held four reproducibility hackathons in collaboration with major CS conferences, including at FAST 2023, ACM REP 2023, ATC/OSDI 2023, and IC2E 2023. In addition, we organized two additional hackathons with the Chameleon community (one at the Chameleon User Meeting in May 2023 and another virtual hackathon in Dec. 2023). These events showed attendees how to package experiments for practical reproducibility and share them on Chameleon’s Trovi service so others could reproduce them. Furthermore, we published a paper (Three Pillars of Practical Reproducibility, https://ieeexplore.ieee.org/document/10254846) at the 2023 IEEE eScience ReWorDS Workshop, outlining the methodology and support needed for practical reproducibility.
...
The discussions of edge computing are emergent with both INRIA and ANL making separate investigations for the time being. The ANL team is working in the context of the CHI@Edge (https://www.chameleoncloud.org/experiment/chiedge/) and FLOTO projects (Discovery Testbed: An Observational Instrument for Broadband Research, https://ieeexplore.ieee.org/abstract/document/10254876). The INRIA team is focusing on two challenges: (1) the efficient provenance data capture at the edge, for reproducibility purposes (ProvLight: Efficient Workflow Provenance Capture on the Edge-to-Cloud Continuum, https://www.computer.org/csdl/proceedings-article/cluster/2023/079200a221/1SfUrCnjgAM), and (2) enabling continual learning and federated learning at the edge, in the context of the ENGAGE project (https://engage.inria.fr/), where initial results target the efficient deployment of such workloads on the edge-cloud continuum (Supporting Efficient Workflow Deployment of Federated Learning Systems across the Computing Continuum, https://scholar.google.com/citations?view_op=view_citation&hl=fr&user=P20GWeYAAAAJ&citation_for_view=P20GWeYAAAAJ:u-x6o8ySG0sC) and securing the learning in the heterogeneous and volatile edge environments (FedGuard: Selective Parameter Aggregation for Poisoning Attack Mitigation in Federated Learning, https://ieeexplore.ieee.org/abstract/document/10319948).
